...
<body class = "bg-primary bg-opacity-50">
	<div class="container-fluid">
		<div class = "position-relative position-absolute top-50 start-50 translate-middle">
			<form class = "p-3 bg-light" action="createuser">
				...
				<div class="mb-3">
					...
					<div class="form-check">
						<input class="form-check-input" type="radio" name="usertype" id="applicant" value = "APPLICANT" checked>
